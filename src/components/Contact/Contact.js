          ...
          <div className="contact__info" data-aos="fade-up">
            ...
            <div className="contact__info-details">
              <ul>
                <li>
                  ...
                  <p>
                    <span>Address:&nbsp;&nbsp;</span>Budhanilkantha, Pasikot
                  </p>
                </li>
                <li>
                  {" "}
                  ...
                  <p>
                    <span>Phone:</span>&nbsp;&nbsp;(+977)-9846978257
                  </p>
                </li>
                <li>
                  {" "}
                  ...
                  <p>
                    <span>Email:&nbsp;&nbsp;</span>prasidadhikari122@gmail.com
                  </p>
                </li>
                <li>
                  {" "}
            ...
            <div className="contact__social">
              <p className="contact__linkedin">
                <a
                  href="https://www.linkedin.com/in/prasiddha-adhikari-9431ba249/"
              ...
              <p className="contact__github">
                <a
                  href="https://github.com/Prasiddha-Adhikari"
                  rel="noopener noreferrer"
                  target="_blank"
                >
